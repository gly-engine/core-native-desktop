...
static gamely_audio_stop_cb_t g_stop_cb  = NULL;
static void                  *g_stop_usr = NULL;
...
void gamely_daemon_media_audio_stop(void) {
    if (g_stop_cb) g_stop_cb(g_stop_usr);
}

__attribute__((constructor))
static void init(void) {
    gecnd_registry("set", "function:gamely_daemon_media_audio_subscribe", (void *)gamely_daemon_media_audio_subscribe, NULL);
    gecnd_registry("set", "function:gamely_daemon_media_audio_on_stop",   (void *)gamely_daemon_media_audio_on_stop,   NULL);
    ...
    gecnd_registry("set", "function:gamely_daemon_media_audio_stop",      (void *)gamely_daemon_media_audio_stop,      NULL);
}
