...
CREATE_GLY_HOOK(void, native_draw_finish, ())
CREATE_GLY_HOOK(void, native_draw_color, (uint32_t))
CREATE_GLY_HOOK(void, native_draw_clear, (uint32_t))
CREATE_GLY_HOOK(void, native_draw_rect, (uint8_t, int16_t, int16_t, int16_t, int16_t, int16_t))
...
CREATE_GLY_HOOK(void, native_image_unload, (int32_t, bool *const))
CREATE_GLY_HOOK(void, native_image_unload_all, (bool *const))
CREATE_GLY_HOOK(void, native_media_source, (uint8_t, const char*))
CREATE_GLY_HOOK(void, native_media_position, (uint8_t, int16_t, int16_t, int16_t, int16_t))
CREATE_GLY_HOOK(void, native_media_play, (uint8_t))
CREATE_GLY_HOOK(void, native_media_pause, (uint8_t))
CREATE_GLY_HOOK(void, native_media_stop, (uint8_t))
CREATE_GLY_HOOK(void, gly_hook_keyboard_has_media, (bool*))
CREATE_GLY_HOOK(void, gly_hook_input_keyboard, (uint8_t, char**, bool*))
CREATE_GLY_HOOK(bool, native_libretro_url, (const char*))
CREATE_GLY_HOOK(void, native_libretro_exit, ())
CREATE_GLY_HOOK(const char*, native_libretro_error, ())
CREATE_GLY_HOOK(void, native_browser_url, (const char*))
CREATE_GLY_HOOK(void, native_browser_exit, ())
